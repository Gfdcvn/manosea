...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[200px] overflow-hidden rounded-md bg-discord-darker border border-gray-700 p-1 text-gray-200 shadow-lg animate-in fade-in-0 zoom-in-95",
        className
      )}
      {...props}
    />
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive
        ...
        : "hover:bg-discord-brand hover:text-white",
      className
    )}
    {...props}
  />
